                                                    ...
                                                    <div class="wt-viewjobholder">
                                                        <ul>
                                                            ...
                                                            @if (!empty($job->location->title))
                                                                <li><span><img src="{{{asset(Helper::getLocationFlag($job->location->flag))}}}" alt="{{{ trans('lang.location') }}}"> {{{ $job->location->title }}}</span></li>
                                                            @endif
                                                            <li><span><img class="wt-job-icon" src="{{asset('images/job-icons/job-type.png')}}">{{{ trans('lang.type') }}} {{{$project_type}}}</span></li>
                                                            <li><span><img class="wt-job-icon" src="{{asset('images/job-icons/job-duration.png')}}">{{{ Helper::getJobDurationList($job->duration)}}}</span></li>
                                                            <li><span><i class="fa fa-tag wt-viewjobtag"></i>{{{ trans('lang.job_id') }}} {{{$job->code}}}</span></li>
                                                            @if (!empty($user->profile->saved_jobs) && in_array($job->id, unserialize($user->profile->saved_jobs)))
                                                                <li style=pointer-events:none;>                
                                                                    <span>
                                                                        <a href="javascript:;" class="wt-clicklike wt-clicksave">
                                                                            <img class="wt-job-icon" src="{{asset('images/job-icons/favorite.png')}}"  alt="Project Level">
                                                                            <em>{{trans("lang.saved")}}</em>
                                                                        </a>
                                                                    </span>                           
                                                                </li>
                                                            @else
                                                                <li>                
                                                                    <span>
                                                                        <a href="javascript:;" class="wt-clicklike wt-add-to-saved_projects" id="job-{{$job->id}}" @click.prevent="add_wishlist('job-{{$job->id}}', {{$job->id}}, 'saved_jobs', '{{trans("lang.saved")}}')">
                                                                            <img class="wt-job-icon" src="{{asset('images/job-icons/favorite.png')}}" alt="Project Level">
                                                                            <em class="save_text">{{ trans('lang.save') }}</em>
                                                                        </a>
                                                                    </span>               
                                                                </li>
                                                            @endif
