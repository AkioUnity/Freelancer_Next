<script src="{{ asset("/js/kyc/particles.min.js") }}"></script>
<script type="text/javascript" src="{!! asset('/js/kyc/parsley.min.js') !!}"></script>
...
/* ------ particles-js ------ */
    ...
    particlesJS.load('particles-js', '/js/kyc/particles.json', function () {
