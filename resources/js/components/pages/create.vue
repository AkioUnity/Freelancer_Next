        ...
        if (evt.added.element.section == 'heading') {
          ...
          this.form.meta.services.push(service)
            ...
            var slider = {
              ...
              description: 'Create.vue etur adipisicing elition sedames dotem iusmod temporei incuntes utnalo labore etdolore maina aliqua enim adion minim veniam quis nsitrud exercitation ullamco laboris nisiutaliquip ex ea commodo.',
              video_link: '',
              video_title: '',
              video_description: '',
              taglineColor:'#ffffff',
