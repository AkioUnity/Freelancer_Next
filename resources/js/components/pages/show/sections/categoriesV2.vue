                    ...
                    <ul class="wt-categoryvtwo wt-categoryvthree">
                        ...
                        <!-- <li>
                            <div class="wt-categorycontentvtwo">
                                ...
                                <div class="wt-cattitlevtwo">
                                    <h4><a href="javascrip:void(0);">Mobiles</a></h4>
                                </div>
                                <div class="wt-description">
                                    <p>Consectetur adipisicing elit deius temor incididunt utnenbo</p>
                                </div>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="wt-categorycontentvtwo">
                                ...
                                <div class="wt-cattitlevtwo">
                                    <h4><a href="javascrip:void(0);">Music &amp; Audio</a></h4>
                                </div>
                                <div class="wt-description">
                                    <p>Consectetur adipisicing elit deius temor incididunt utnenbo</p>
                                </div>
                        ...
                        <li>
                            <div class="wt-categorycontentvtwo">
                                ...
                                <div class="wt-cattitlevtwo">
                                    <h4><a href="javascrip:void(0);">Programming &amp; Tech</a></h4>
                                </div>
                                <div class="wt-description">
                                    <p>Consectetur adipisicing elit deius temor incididunt utnenbo</p>
                                </div>
                        ...
                        <li>
                            <div class="wt-categorycontentvtwo">
                                ...
                                <div class="wt-cattitlevtwo">
                                    <h4><a href="javascrip:void(0);">Business</a></h4>
                                </div>
                                <div class="wt-description">
                                    <p>Consectetur adipisicing elit deius temor incididunt utnenbo</p>
                                </div>
                        ...
                        <li class="wt-morecategory">
                            <div class="wt-categorycontentvtwo">
                                ...
                                <div class="wt-btnarea">
                                    <a :href="category.showAllBtnUrl" class="wt-btntwo">Show All</a>
                                </div>
                            </div>
                        </li>
                    </ul>
