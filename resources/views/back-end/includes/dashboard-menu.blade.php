                    ...
                    @if ($role === 'admin')
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <hr>
                                    <a href="{{{ route('articles') }}}">{{ trans('lang.articles') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{{ route('articleCategories') }}}">{{ trans('lang.categories') }}</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{{ route('goPm') }}}" target="_blank">
                                <i class="ti-desktop"></i>
                                <span>{{ trans('Project Management') }}</span>
                            </a>
                        </li>
                        <li class="menu-item-has-children">
                            <span class="wt-dropdowarrow"><i class="lnr lnr-chevron-right"></i></span>
                            <a href="javascript:void(0)">
                                ...
                                <span>{{ trans('Exam') }}</span>
                            </a>
                            <ul class="sub-menu">
                                <li>
                                    <hr>
                                    <a href="{{url('/admin/topics')}}">{{ trans('Quiz') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{url('/admin/questions')}}">{{ trans('Questions') }}</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <hr>
                                    <a href="{{{ route('skills') }}}">{{ trans('lang.skills') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{{ route('categories') }}}">{{ trans('lang.job_cats') }}</a></li>
                                <li><hr><a href="{{{ route('departments') }}}">{{ trans('lang.dpts') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{{ route('languages') }}}">{{ trans('lang.langs') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{{ route('locations') }}}">{{ trans('lang.locations') }}</a></li>
                                <li>
                                    <hr>
                                    <a href="{{{ route('badges') }}}">{{ trans('lang.badges') }}</a></li>
                    ...
                    @if ($role === 'employer' || $role === 'freelancer' )
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <hr>
                                    <a href="{{{ route('manageAccount') }}}">{{ trans('lang.acc_settings') }}</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{{ url('/kyc') }}}">
